        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button
                    ...
                    className={cn(
                        "h-auto w-full gap-5 rounded-[5px] border border-brand-purple/20 bg-[#292031] px-5 py-4 text-[#DFD8F5] transition-all duration-200 hover:bg-[#292031]",
                        ...
                        <CommandGroup
                            ...
                            {items.map((info) => (
                                <CommandItem
                                    ...
                                    className="bg-[#14121733] py-2 aria-selected:bg-[#935c2d] hover:cursor-pointer">
