...
export const FLOW_METRICS_PATH = {
    ...
    GET_TEAM_FLOW_METRICS: pathToApiUrl("/metrics/get-cockpit-data"), // TODO: remove, unused
    GET_ORGANIZATION_CHART_FLOW_DATA: pathToApiUrl(
        "/metrics/get-by-organization-id",
    ), // TODO: remove, unused
    GET_TEAM_CHART_FLOW_DATA: pathToApiUrl("/metrics/get-by-team-id"), // TODO: remove, unused
} as const;
